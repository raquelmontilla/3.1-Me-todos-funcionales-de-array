...
const userErrorPin = users.find(user => user.pin === 5232);

console.log(userErrorPin);
...
const userErrorPinIndex = users.findIndex(user => user.pin === 5232);

console.log(userErrorPinIndex);

users.splice(userErrorPinIndex);
